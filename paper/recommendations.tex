...
roadmap for financial institutions.  P0 and P1 recommendations are
directly supported by the framework's implemented signals or measured
gaps.  P2 and P3 recommendations are policy and infrastructure
hypotheses motivated by the threat model; they require independent legal,
privacy, and operational validation before deployment.  Each
recommendation is scored on a weighted composite of \emph{impact}
(40\%), \emph{urgency} (30\%), \emph{feasibility} (20\%), and
\emph{cost} (10\%), then assigned to one of four priority tiers.
...
\begin{table}[t]
  ...
  \begin{tabularx}{\textwidth}{@{}c l c X@{}}
    ...
    \addlinespace[2pt]
    R6 & Controller step-up authentication
       & P2 / 12--24\,mo
       & Require additional authentication of the controlling human or
         legal entity for high-risk agent-initiated transactions. The
         feasibility of this control is no longer hypothetical: production
         agent wallets now ship default transaction-time step-up and
         policy limits~\cite{metamask2026agentwallet}, and AP2 standardizes
         consent mandates~\cite{ap2protocol2025}; the open item is
         banking-side integration, and the biometric modality, if any,
         should be selected only after privacy and accessibility review. \\
    \addlinespace[2pt]
...
\noindent
In summary, the P0 and P1 tiers are the recommendations most directly
grounded in the measurements reported here.  P2 items (R6--R8) remain
policy proposals: they may be useful, but they should be treated as
requirements for further institutional and regulatory analysis rather
than as validated outcomes of the detection experiment.
