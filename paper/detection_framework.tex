...
inactive signal.  We note that the narrow AUC spread across signals
(0.4647--0.5990) produces near-uniform weights ($\sigma_w = 0.015$);
AUC-proportional weighting is effectively equivalent to equal
weighting on this dataset.  We retain it as a principled default
that will differentiate signals as the evaluation set grows and
AUC values diverge.
