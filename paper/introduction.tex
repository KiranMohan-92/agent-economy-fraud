...
\begin{enumerate}[leftmargin=*,nosep]
  ...
  \item \textbf{Three-stage empirical validation.} Evaluation across synthetic data (F1\,=\,88.71\%, AUC\,=\,0.97), real on-chain transactions (recall\,=\,95.4\% at a re-optimized threshold, composite ROC-AUC\,=\,0.515 on cleaned labels), and injection testing (7/8 attack chains detected at 100\% recall) (\cref{sec:evaluation}). The low real-data AUC reflects negative-class contamination rather than ranking power; we report it prominently to avoid overstating detection capability.
